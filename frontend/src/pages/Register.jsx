...
import { Eye, EyeOff, Mail, Lock, User, Scale, Sparkles, FileText } from 'lucide-react';
...
const Register = () => {
  ...
  const { signUpWithEmail, signInWithGoogle, loading, error } = useAuthStore();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-[0.03]" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23475569'%3E%3Cpath d='M20 20m-1 0a1 1 0 1 1 2 0a1 1 0 1 1-2 0'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
        }}></div>
        
        {/* Floating legal elements */}
        <div className="absolute top-20 left-20 w-80 h-80 bg-gradient-radial from-blue-100/15 to-transparent rounded-full filter blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-64 h-64 bg-gradient-radial from-indigo-100/12 to-transparent rounded-full filter blur-3xl animate-pulse delay-700"></div>
        
        {/* Geometric patterns representing legal structure */}
        <div className="absolute top-1/3 left-8 w-28 h-28 border border-slate-200/25 transform rotate-45 animate-pulse delay-1000"></div>
        <div className="absolute bottom-1/3 right-8 w-36 h-36 border border-blue-200/20 rounded-lg transform -rotate-12 animate-pulse delay-500"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 border border-indigo-200/15 rounded-full animate-pulse delay-300"></div>
        
        {/* Subtle legal icons */}
        <div className="absolute top-12 right-12 opacity-[0.025]">
          <Scale className="h-52 w-52 text-slate-600 transform rotate-15" />
        </div>
        <div className="absolute bottom-12 left-12 opacity-[0.02]">
          <FileText className="h-44 w-44 text-blue-600 transform -rotate-8" />
        </div>
      </div>
